...
|---|---|---|---|---|---|
| A · direct | 33 | 82% | 55% | 27% | — |
| B · pseudocode | 33 | 91% | 55% | 36% | 510 |
| C · prose-matched | 33 | 88% | 64% | 24% | 355 |

_Headline (Plus): **B−A = +0 pts**, **B−C = -9 pts** (load-bearing). Compute match: B≈510w vs C≈355w._
...
| Arm | n | Base pass | Plus pass | Edge gap | Artifact words |
|---|---|---|---|---|---|
| A · direct | 45 | 87% | 67% | 20% | — |
| B · pseudocode | 45 | 93% | 67% | 27% | 459 |
| C · prose-matched | 45 | 91% | 73% | 18% | 337 |

_Headline (Plus): **B−A = +0 pts**, **B−C = -7 pts** (load-bearing). Compute match: B≈459w vs C≈337w._
...
| Task | Source | A | B | C |
|---|---|---|---|---|
| lcb/abc325_d | livecodebench | 100% | 100% | 67% |
| lcb/abc325_e | livecodebench | 0% | 0% | 100% |
| lcb/abc324_d | livecodebench | 0% | 0% | 33% |
| lcb/abc324_e | livecodebench | 100% | 100% | 100% |
| lcb/abc323_d | livecodebench | 0% | 0% | 0% |
| lcb/abc323_e | livecodebench | 100% | 100% | 100% |
| lcb/abc322_e | livecodebench | 100% | 100% | 100% |
| lcb/abc320_e | livecodebench | 100% | 100% | 100% |
| lcb/abc319_e | livecodebench | 0% | 0% | 0% |
