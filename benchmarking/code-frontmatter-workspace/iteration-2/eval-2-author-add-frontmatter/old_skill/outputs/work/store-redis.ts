/**
 * ---
 * purpose: Redis-backed LinkStore - IDs from INCR, records as hashes keyed by slug
 * exports:
 *   - RedisStore - implements LinkStore; build via fromConfig(redis)
 * related:
 *   - ./store.ts - LinkStore interface and InMemoryStore alternative
 *   - ./config.ts - redisKeyPrefix
 * ---
 */
