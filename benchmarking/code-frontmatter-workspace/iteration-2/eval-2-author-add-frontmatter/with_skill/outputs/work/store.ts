/**
 * ---
 * purpose: LinkStore storage interface plus LinkRecord shape and an in-memory implementation.
 * related:
 *   - ./store-redis.ts - production Redis implementation of this interface
 *   - ./shortener.ts - consumes a LinkStore to persist and look up links
 * ---
 */
