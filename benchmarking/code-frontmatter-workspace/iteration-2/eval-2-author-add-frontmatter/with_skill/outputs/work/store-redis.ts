/**
 * ---
 * purpose: Redis-backed LinkStore - sequence counter for IDs, hash per link, click increments.
 * related:
 *   - ./store.ts - LinkStore interface and LinkRecord shape it implements
 *   - ./config.ts - supplies the key prefix via fromConfig
 * ---
 */
