/**
 * ---
 * purpose: HTTP entry point - POST /shorten to create a link, GET /:slug to redirect.
 * related:
 *   - ./shortener.ts - core shorten/resolve logic this wires to HTTP
 *   - ./store-redis.ts - Redis-backed store injected into the Shortener
 *   - ./config.ts - supplies the listen port
 * ---
 */
