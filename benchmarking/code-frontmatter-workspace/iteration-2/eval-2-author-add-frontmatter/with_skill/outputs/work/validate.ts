/**
 * ---
 * purpose: Validate and normalise a target URL, rejecting non-http(s) and private/loopback hosts (SSRF guard).
 * related:
 *   - ./shortener.ts - calls validateTarget before persisting a new link
 * ---
 */
