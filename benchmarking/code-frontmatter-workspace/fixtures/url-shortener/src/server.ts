/**
 * ---
 * purpose: HTTP entry point; maps POST /shorten and GET /:slug onto the Shortener service
 * related:
 *   - ./shortener.ts - the service this exposes over HTTP
 *   - ./store-redis.ts - the backend wired up at startup
 *   - ./config.ts - provides the listen port
 * ---
 */
