/**
 * ---
 * purpose: HTTP entry point - POST /shorten creates links, GET /:slug 302-redirects.
 * related:
 *   - ./shortener.ts - core shorten/resolve logic this wires up
 *   - ./store-redis.ts - backend wired in at startup
