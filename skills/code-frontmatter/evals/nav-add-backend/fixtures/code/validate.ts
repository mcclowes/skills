/**
 * ---
 * purpose: Validates and normalises submitted target URLs before they are shortened
 * related:
 *   - ./shortener.ts - rejects invalid targets using isValidTarget() before minting a slug
 * ---
 */
